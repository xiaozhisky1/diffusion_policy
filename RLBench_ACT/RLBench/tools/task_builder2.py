...
from rlbench.backend.const import TTT_FILE, TTT_FILE_Ours
...
if __name__ == '__main__':
    ...
    parser.add_argument("--robot", default='sawyer', help="the name of your robot.")
    ...
    ttt_file = join(CURRENT_DIR, '..', 'rlbench', f'{TTT_FILE_Ours}_{robot_name}.ttt') 
    
    pr.launch(ttt_file, responsive_ui=True)
    pr.step_ui()

    robot = Robot(arm_class(), gripper_class())
